...
-- controls 
skin.controls = {}
skin.controls.smallfont = love.graphics.newFont("res/dejaVuSansRegular.ttf", fontSize)
skin.controls.imagebuttonfont = love.graphics.newFont("res/dejaVuSansRegular.ttf", fontSize)

-- frame
skin.controls.frame_body_color  = {1, 1, 1, 1}
skin.controls.frame_name_color = {1, 1, 1, 1}
skin.controls.frame_name_font = skin.controls.smallfont

skin.controls.text_font = skin.controls.smallfont

-- button
skin.controls.button_text_down_color  = {1, 1, 1, 1}
skin.controls.button_text_nohover_color = {0, 0, 0, 1}
skin.controls.button_text_hover_color = {1, 1, 1, 1}
skin.controls.button_text_nonclickable_color = {0, 0, 0, 1}
...
skin.controls.multichoicerow_body_hover_color = {0.678, 0.847, 0.902, 1}
skin.controls.multichoicerow_text_nohover_color = {0, 0, 0, 1}
...
skin.controls.textinput_highlight_bar_color = {0.678, 0.847, 0.902, 1}
skin.controls.textinput_font = skin.controls.smallfont
...
skin.controls.columnlistheader_text_nohover_color = {0, 0, 0, 1}
skin.controls.columnlistheader_text_hover_color = {1, 1, 1, 1}
skin.controls.columnlistheader_text_font = skin.controls.smallfont

-- columnlistrow
skin.controls.columnlistrow_body1_color = {0.91, 0.91, 0.91, 1}
skin.controls.columnlistrow_body2_color = {0.91, 0.91, 0.91, 1}
skin.controls.columnlistrow_body_selected_color = {0.678, 0.847, 0.902, 1}
skin.controls.columnlistrow_body_hover_color = {0.91, 0.91, 0.91, 1}
skin.controls.columnlistrow_text_color = {0, 0, 0, 1}
skin.controls.columnlistrow_text_hover_color = {0, 0, 0, 1}
skin.controls.columnlistrow_text_selected_color = {1, 1, 1, 1}
skin.controls.columnlistrow_font = skin.controls.smallfont
...
function skin.text(object)
	...
	for k, v in ipairs(textdata) do
		...
		local text = v.text
		local color = v.color
		local font = skin.controls.text_font
		local link = v.link
		local theight = font:getHeight("a")
		if inlist then
			local listy = list.y
...
function skin.textinput(object)
	...
	local width = object:GetWidth()
	local height = object:GetHeight()
	local font = skin.controls.textinput_font
